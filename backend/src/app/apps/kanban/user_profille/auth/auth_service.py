...
from .....user_auth.auth.auth_service import AuthService as User_AuthService
...
class AuthService:
    ...
    async def authenticate_by_login(self, login: str, password: str) -> TokenPair:
        ...
        """
        auth_service = User_AuthService(self.user_service)
        
        tokens = await auth_service.authenticate_by_login(login = login, password = password)
        
        # await self.user_service.get_user_by_login( login)
    ...
    async def refresh_tokens(self, refresh_token: str) -> TokenPair:
        ...
        responce = await auth_service.refresh_tokens(refresh_token = refresh_token)
